...
// Tue Aug 28 09:51:54 2018 by ROOT version 6.12/06
// from TTree LHEF/Analysis tree
// found on file: new_test.root
//////////////////////////////////////////////////////////

#ifndef findParticle_h
#define findParticle_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   findParticle(TTree *tree=0);
   virtual ~findParticle();
...
#ifdef findParticle_cxx
findParticle::findParticle(TTree *tree) : fChain(0) 
{
...
findParticle::~findParticle()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t findParticle::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t findParticle::LoadTree(Long64_t entry)
{
...
void findParticle::Init(TTree *tree)
{
...
void findParticle::Show(Long64_t entry)
{
...
Int_t findParticle::Cut(Long64_t entry)
{
